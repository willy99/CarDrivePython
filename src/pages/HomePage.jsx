...
const TRANSLATIONS = {
  en: {
    ...
    miner: { title: 'BaBOOM', description: 'Topographic minesweeper: send your sapper across cleared ground, dodge mines, work up from squares to wild map shapes.' },
  ...
  uk: {
    ...
    miner: { title: 'БаБУМ', description: 'Топографічний сапер: веди сапера по розмінованому, обходь міни, рости від квадратів до диких карт.' },
...
const GAME_IDS = ['cardrive', 'hanoi', 'memorize', 'engineer', 'miner']
