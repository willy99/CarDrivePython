...
_STRINGS = {
    ...
    "home.v.arrows":      {"en": "drive (Up gas, Down brake)",
                           "uk": "керуй (UP - газ, DOWN - гальмує)"},
    "home.k.lr":          {"en": "L / R",    "uk": "Ліворуч / Праворуч"},
    "home.v.lr":          {"en": "steer when moving", "uk": "Не єлозь кермом коли стоїш"},
    "home.k.honk":        {"en": "H",        "uk": "H"},
    "home.v.honk":        {"en": "honk, make others go away",
                           "uk": "бібікні, щоб дали дорогу"},
    ...
    "home.mv.rain":       {"en": "less grip, longer slides",
                           "uk": "менше зчеплення, заноси і відкриті люки"},
