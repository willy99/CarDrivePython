...
const STRINGS = {
  ...
  uk: {
    ...
    hintMoveKeys: 'Стрілки або тицни розмінований ґрунт щоб рухатись. Утримання — прапорець.',
    howToPlay: '📖 Як грати',
    ...
    htCtrlPlaceD: 'Десант сапера на поле (перший тик завжди безпечний)',
    htCtrlReveal: 'Тицни відкритий ґрунт',
    htCtrlRevealD: 'Рухай сапера туди (аркада) або відкривай в класиці',
    ...
    htModeArcade: 'Аркада — сапер ходить по карті. Тицни відкритий ґрунт або стрілки щоб рухатись. Тицни нерозмінувану клітинку щоб відкрити.',
    ...
    htGearP: 'Після кожної операції можна знайти артефакти прямо на полі. Збирай їх у Шафу, потім бери до 2 штук в рюкзак перед наступною операцією. Артефакти дають потужні одноразові здатності.',
    htArtifactsTitle: 'Всі артефакти',
    htRanksTitle: 'Звання',
    htRanksP: 'Проходь операції — заробляй очки звання. Чим більше полів розмінуєш, тим вище звання: від Рекрута до Генерала.',
    htTimedTitle: 'Операції на час',
    htTimedP: 'Деякі операції мають таймер зворотного відліку. Розмінуй поле до кінця часу, інакше програш. Таймер жовтіє при <60 с та червоніє при <30 с.',
