...
const STRINGS = {
  en: {
    ...
    arcadeOnly: '🕹 Arcade only',
    vipHint: 'VIP protection — flag all mines around 👤, then reach the VIP cell to extract.',
  ...
  uk: {
    ...
    arcadeOnly: '🕹 Лише аркада',
    vipHint: 'Охорона VIP — познач всі міни навколо 👤, потім дійди до нього щоб евакуювати.',
